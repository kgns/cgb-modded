...
$y += 75
	...
	$grpCustom = GUICtrlCreateGroup("Custom", $x - 20, $y - 20, 450, 190)
		...
		$cmbDonateCustom1 = GUICtrlCreateCombo("", $x+260, $y+23, 95, 25, BitOR($CBS_DROPDOWNLIST, $CBS_AUTOHSCROLL))
			GUICtrlSetData(-1, "Barbarian|Archer|Giant|Goblin|Balloon|W.Breaker|Wizard|Healer|Dragon|Pekka|Minion|HogRider|Valkyrie|Golem|Witch|Lava|Nothing", "Wizard")
			GUICtrlSetState(-1, $GUI_HIDE)
		...
		$cmbDonateCustom2 = GUICtrlCreateCombo("", $x+260, $y+45, 95, 25, BitOR($CBS_DROPDOWNLIST, $CBS_AUTOHSCROLL))
			GUICtrlSetData(-1, "Barbarian|Archer|Giant|Goblin|Balloon|W.Breaker|Wizard|Healer|Dragon|Pekka|Minion|HogRider|Valkyrie|Golem|Witch|Lava|Nothing", "Barbarian")
			GUICtrlSetState(-1, $GUI_HIDE)
		...
		$cmbDonateCustom3 = GUICtrlCreateCombo("", $x+260, $y+67, 95, 25, BitOR($CBS_DROPDOWNLIST, $CBS_AUTOHSCROLL))
			GUICtrlSetData(-1, "Barbarian|Archer|Giant|Goblin|Balloon|W.Breaker|Wizard|Healer|Dragon|Pekka|Minion|HogRider|Valkyrie|Golem|Witch|Lava|Nothing", "Archer")
			GUICtrlSetState(-1, $GUI_HIDE)
...
Local $x = 30, $y = 125
	...
	$grpLocateBuildings = GUICtrlCreateGroup("Resources for Upgrade Buildings", $x - 20, $y - 20, 220, 110)
		...
		GUICtrlSetData(-1, "Barbarians|Archers|Giants|Goblin|Balloon|W.Breaker|Wizard|Healer|Dragon|Pekka|Lightning|Healing|Rage|Jump Spell|Freeze|Minion|HogRider|Valkrye|Golem|Witch|Lava|Nothing", "Archers")
		;GUICtrlSetState(-1, $GUI_ENABLE)
