...
Func getChar(ByRef $x, $y)
	;Duplicated itens because each computer gets different color in the same pixel
	Local $charWidth[122] = [2, 3, 2, 3, 2, 3,			_	;{space} i l I , j ; hardest cases
							7,6, 7,7, 7,6, 7,6, 6,6,	_	;Aa Bb Cc Dd Ee
							6,6, 7,6, 8,6, 7,			_	;Ff Gg Hh J
							8,7, 5,   11,10, 8,6, 7,6,	_	;Kk L  Mm Nn Oo
							7,6, 7,6, 8,6, 7,6, 6,7,	_	;Pp Qq Rr Ss Tt
							7,6, 8,6, 11,10, 8,6, 8,6,	_	;Uu Vv Ww Xx Yy
							8,5,						_	;Zz ------------------------- macOS from here
						    2, 3, 2, 3, 2, 3,			_	;{space} i l I , j ; hardest cases
							7,6, 7,7, 7,6, 7,6, 6,6,	_	;Aa Bb Cc Dd Ee
							6,6, 7,6, 8,6, 7,			_	;Ff Gg Hh J
							8,7, 5,   11,10, 8,6, 7,6,	_	;Kk L  Mm Nn Oo
							7,6, 7,6, 8,6, 7,6, 6,7,	_	;Pp Qq Rr Ss Tt
							7,6, 8,6, 11,10, 8,6, 8,6,	_	;Uu Vv Ww Xx Yy
							8,5,						_	;Zz
							7,6, 7,6, 6,6, 6,6,			_	;Áá Ãã Éé Êê
						    3,3, 7,6, 7,6]				_	;Íí Óó Úú

	Local $charString[122] = [" ", "i", "l", "I", ",", "j", _
							...
							"U", "u", "V", "v", "W", "w", "X", "x", "Y", "y", _
							"Z", "z", _
							"Á", "á", "Ã", "ã", "É", "é", "Ê", "ê", "Í", "í", "Ó", "ó", "Ú", "ú"]

	Local $charOffset[122][3][2] = _
[[[1,3], [1,7], [2,5]], [[1,1], [1,2], [1,8]], [[1,2], [0,2], [1,7]], [[1,2], [2,5], [1,8]], [[1,7], [1,8], [1,9]], [[1,0], [1,4], [1,9]],	_	;{space} i l I , j
 ...
 [[2,1], [5,5], [3,8]], [[1,8], [3,7], [3,10]],[[2,2], [1,7], [5,7]], [[1,4], [3,5], [2,8]],												_	;Yy Zz ------------------------- macOS from here
 [[1,3], [1,7], [2,5]], [[1,1], [1,2], [1,8]], [[1,2], [0,2], [1,8]], [[1,2], [2,5], [1,8]], [[1,7], [1,8], [1,9]], [[1,0], [1,4], [1,9]],	_	;{space} i l I , j
 [[1,8], [5,7], [6,8]], [[4,3], [1,4], [3,0]], [[6,1], [1,1], [3,4]], [[3,4], [4,7], [1,1]], [[1,1], [2,2], [5,3]], [[3,2], [5,8], [4,4]],	_ 	;Aa Bb Cc
 [[3,7], [6,1], [2,3]], [[3,4], [4,7], [1,3]], [[2,6], [2,2], [3,0]], [[3,2], [2,3], [4,6]], [[3,2], [1,8], [5,1]], [[5,1], [2,4], [2,8]],	_	;Dd Ee Ff
 [[4,4], [3,0], [4,5]], [[1,9], [3,8], [4,4]], [[5,8], [3,3], [1,1]], [[2,5], [3,4], [5,3]], 												_	;Gg Hh
 [[1,5], [4,7], [6,1]], [[2,3], [3,6], [6,0]], [[1,1], [2,1], [4,8]], [[2,7], [4,7], [1,0]], 												_	;J Kk L
 [[4,8], [6,1], [8,8]], [[1,8], [7,2], [5,4]], [[3,1], [5,4], [6,1]], [[5,3], [4,8], [2,5]], [[2,6], [2,0], [5,6]], [[2,4], [4,5], [3,2]],	_	;Mm Nn Oo
 [[4,2], [2,8], [5,3]], [[2,4], [1,10],[5,3]], [[4,9], [2,2], [6,4]], [[3,4], [4,8], [4,10]],[[4,2], [3,6], [6,1]], [[4,5], [2,6], [2,2]],	_	;Pp Qq Rr
 [[2,0], [5,4], [3,7]], [[2,2], [4,4], [2,7]], [[1,0], [4,2], [2,8]], [[2,1], [1,8], [4,6]], [[1,1], [1,8], [5,1]], [[2,3], [2,7], [4,3]],	_	;Ss Tt Uu
 [[2,2], [3,5], [5,7]], [[2,3], [3,6], [5,3]], [[2,3], [6,1], [9,8]], [[3,5], [5,7], [8,8]], [[1,2], [3,7], [5,4]], [[1,4], [2,8], [5,6]],	_	;Vv Ww Xx
 [[2,1], [5,5], [3,8]], [[1,8], [3,7], [3,10]],[[2,2], [1,7], [5,7]], [[1,4], [3,5], [2,8]],												_	;Yy Zz
 [[1,8], [5,7], [4,0]], [[2,2], [1,4], [3,0]], [[1,8], [5,7], [4,0]], [[4,3], [1,4], [3,0]], [[2,6], [2,2], [3,0]], [[3,2], [2,3], [4,6]],	_ 	;Áá Ãã Éé
 [[2,6], [2,2], [3,0]], [[3,2], [2,3], [4,6]], [[1,2], [2,5], [1,8]], [[1,1], [1,2], [1,8]], [[2,6], [2,0], [5,6]], [[2,4], [4,5], [3,2]],	_	;Êê Íí Óó
 [[1,1], [1,8], [4,0]], [[2,3], [2,7], [3,1]]]																									;Úú

	Local $charColor[122][3] = _
[[0x3F4440,0x3F4440,0x3F4440],[0xF0F1F0,0x454945,0xE1E1E1],[0xFEFEFE,0x909290,0xFEFEFE],[0xFEFEFE,0xA3A5A3,0xE1E1E1],[0xE8E8E8,0xFEFEFE,0xA5A7A5],[0x9FA2A0,0xFDFEFD,0xFDFEFD], _	;{space} i l I , j
 ...
 [0xA1A3A1,0x8C8E8C,0xD5D6D5],[0x5D615D,0xEEEEEE,0xE8E9E8],[0x505450,0x707370,0x888B88],[0x757775,0x757875,0xDADBDA],															_	;Yy Zz	------------------------- macOS from here										;Yy Zz
 [0x3F4440,0x3F4440,0x3F4440],[0xF0F0F0,0x464A46,0xE1E2E1],[0xFEFEFE,0x909290,0xDBDCDB],[0xFFFFFF,0xA3A5A3,0xE1E2E1],[0xE8E8E8,0xFEFEFE,0xA5A7A5],[0x9FA19F,0xFDFDFD,0xFEFFFE], _	;{space} i l I , j
 [0xE6E7E6,0xDCDBDC,0xD6D7D6],[0xFAFAFA,0xC2C4C2,0x404440],[0xE0E1E0,0xFAFAFA,0xE7E7E7],[0x8D908D,0xCACBCA,0xFAFAFA],[0xE7E7E7,0xC9CAC9,0xDBDCDB],[0x818481,0x939593,0xEEEEEE], _	;Aa Bb Cc
