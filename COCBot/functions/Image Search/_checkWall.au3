...
$Wall[0][1] = @ScriptDir & "\images\Walls\10.bmp"
...
Func CheckWallLv()
	...
	If _ImageSearch($WallLv[$icmbWalls], 1, $x, $y, 90) Then ; Getting Wall level
		$WallLvc = 1
...
Func CheckWallWord()
	...
	If _ImageSearch(@ScriptDir & "\images\Walls\wallword.bmp", 1, $x, $y, 90) or _
	_ImageSearch(@ScriptDir & "\images\Walls\wallword1.bmp", 1, $x, $y, 90) Then ; Getting Wall word
		$WallWord = 1
